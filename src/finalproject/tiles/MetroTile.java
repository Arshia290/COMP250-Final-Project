...
public class MetroTile extends Tile {
    ...
    public void fixMetro(Tile node) {
        int formula = Math.abs(this.xCoord - node.xCoord) + Math.abs(this.yCoord - node.yCoord);
        this.metroTimeCost = formula * metroCommuteFactor;
        this.metroDistanceCost = formula/metroCommuteFactor;
    }
}
